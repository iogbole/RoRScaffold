...
class JedisControllerTest < ActionController::TestCase
  ...
  test "should create jedi" do
    assert_difference('Jedi.count') do
      post :create, jedi: { first_name: @jedi.first_name, last_name: @jedi.last_name, location: @jedi.location, sex: @jedi.sex }
    end
  ...
  test "should update jedi" do
    patch :update, id: @jedi, jedi: { first_name: @jedi.first_name, last_name: @jedi.last_name, location: @jedi.location, sex: @jedi.sex }
    assert_redirected_to jedi_path(assigns(:jedi))
  end
